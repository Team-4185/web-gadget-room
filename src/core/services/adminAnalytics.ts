...
interface IAdminSalesAnalyticsApiPoint {
  date?: string;
  label?: string;
...
interface IAdminSalesAnalyticsApiResponse {
...
const normalizePoint = (point: IAdminSalesAnalyticsApiPoint, index: number): IAdminSalesAnalyticsPoint => {
