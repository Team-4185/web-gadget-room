...
export const PaymentSection = ({
  ...
  const selectOnlinePayment = (method: OnlinePaymentType) => {
    onPaymentMethodChange('online');
    onOnlinePaymentChange(method);
  };
        ...
        <div className="payment-section__option payment-section__option--expanded">
          <div className="payment-section__payment-list">
            <button
              ...
              onClick={() => selectOnlinePayment('card')}
            >
              <div className="payment-section__option-left">
                <RadioButton checked={paymentMethod === 'online' && onlinePayment === 'card'} />
                <Typography variant="body1" sx={{ fontWeight: 600 }}>
                  By card online
                </Typography>
              </div>
            ...
            <button
              type="button"
              className="payment-section__payment-item"
              onClick={() => selectOnlinePayment('gpay')}
            >
              <div className="payment-section__option-left">
                <RadioButton checked={paymentMethod === 'online' && onlinePayment === 'gpay'} />
                <Typography variant="body1" sx={{ fontWeight: 600 }}>
                  Google Pay
                </Typography>
              </div>
            ...
            <button
              type="button"
              className="payment-section__payment-item"
              onClick={() => selectOnlinePayment('apay')}
            >
              <div className="payment-section__option-left">
                <RadioButton checked={paymentMethod === 'online' && onlinePayment === 'apay'} />
                <Typography variant="body1" sx={{ fontWeight: 600 }}>
                  Apple Pay
                </Typography>
              </div>
